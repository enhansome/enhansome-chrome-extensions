# Awesome Chrome extensions with stars

*Please read [contribution guidelines](contributing.md) before contributing.*

## Developer

* [Refined GitHub](https://github.com/sindresorhus/refined-github) ⭐ 31,932 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-15 - Simplifies the GitHub interface and adds useful features.
...
* [VisBug](https://github.com/GoogleChromeLabs/ProjectVisBug) ⭐ 5,766 | 🐛 245 | 🌐 JavaScript | 📅 2026-08-03 - Make any webpage feel like an artboard.
...
* [Buster](https://github.com/dessant/buster) ⭐ 9,256 | 🐛 49 | 🌐 JavaScript | 📅 2026-06-27 - Captcha solver extension for humans.
* [Violentmonkey](https://github.com/violentmonkey/violentmonkey) ⭐ 8,742 | 🐛 79 | 🌐 JavaScript | 📅 2026-08-13 - Provides userscripts support for browsers.
* [Stylus](https://github.com/openstyles/stylus/) ⭐ 6,821 | 🐛 93 | 🌐 JavaScript | 📅 2026-08-14 - Lets you customize websites to any color scheme you like with a lot of styles that you can already choose from.
* [Surfingkeys](https://github.com/brookhong/Surfingkeys) ⭐ 6,145 | 🐛 447 | 🌐 JavaScript | 📅 2026-08-15 - Map your keys for web surfing, expand your browser with javascript and keyboard.
...
* [Reddit Enhacement Suite](https://github.com/honestbleeps/Reddit-Enhancement-Suite) ⭐ 4,503 | 🐛 685 | 🌐 JavaScript | 📅 2026-08-12 - Includes many features that enhances your Reddit browsing experience.
* [Video Speed Controller](https://github.com/igrigorik/videospeed) ⭐ 4,406 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-15 - HTML5 video speed controller.
* [Search by Image](https://github.com/dessant/search-by-image) ⭐ 3,712 | 🐛 78 | 🌐 JavaScript | 📅 2026-06-27 - Browser extension for reverse image search.
* [Redirector](https://chrome.google.com/webstore/detail/redirector/ocgpenflpmgnfapjedencafcfakcekcd) - Automatically redirect pages based on user-defined rules. Examples [here](https://github.com/einaregilsson/Redirector/wiki/Examples-From-Help-File) ⭐ 2,074 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27 and [here](https://github.com/einaregilsson/Redirector/wiki/Some-Examples) ⭐ 2,074 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27.
* [Cookie AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) ⭐ 2,013 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26 - Extension that deletes cookies as soon as the tab closes. [Documentation](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete/wiki/Documentation) ⭐ 2,013 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26 and [FAQ](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete/wiki/FAQ:-Common-Questions-and-Issues) ⭐ 2,013 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26.
* [Web Archives](https://github.com/dessant/web-archives) ⭐ 1,583 | 🐛 28 | 🌐 JavaScript | 📅 2026-06-27 - Browser extension for viewing archived and cached versions of web pages.
...
* [KeePass Tusk](https://github.com/suBDavis/Tusk) ⭐ 522 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-12 - KeePass-compatible browser extension for filling passwords.
* [NooBoss](https://github.com/AInoob/NooBoss) ⭐ 329 | 🐛 44 | 🌐 JavaScript | 📅 2025-01-10 - Powerful Extensions Manager and Userscript Manager with many unique features.
* [SimpleLogin](https://github.com/simple-login/browser-extension) ⭐ 241 | 🐛 45 | 🌐 Vue | 📅 2025-03-20 - Protect your email address using email alias. 100% open source and can be self-hosted.
...
* [Smart HTTPS](https://github.com/ilGur1132/Smart-HTTPS) ⭐ 86 | 🐛 27 | 🌐 JavaScript | 📅 2026-01-26 - Automatically changes HTTP addresses to the secure HTTPS, and if loading encounters error, reverts it back to HTTP.
