...
* [Refined GitHub](https://github.com/sindresorhus/refined-github) ⭐ 32,190 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-20 - Simplifies the GitHub interface and adds useful features.
...
* [Violentmonkey](https://github.com/violentmonkey/violentmonkey) ⭐ 8,911 | 🐛 81 | 🌐 JavaScript | 📅 2026-09-21 - Provides userscripts support for browsers.
* [Stylus](https://github.com/openstyles/stylus/) ⭐ 6,894 | 🐛 97 | 🌐 JavaScript | 📅 2026-09-20 - Lets you customize websites to any color scheme you like with a lot of styles that you can already choose from.
* [Surfingkeys](https://github.com/brookhong/Surfingkeys) ⭐ 6,174 | 🐛 421 | 🌐 JavaScript | 📅 2026-09-21 - Map your keys for web surfing, expand your browser with javascript and keyboard.
...
* [Video Speed Controller](https://github.com/igrigorik/videospeed) ⭐ 4,435 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-10 - HTML5 video speed controller.
