...
* [Refined GitHub](https://github.com/sindresorhus/refined-github) ⭐ 31,926 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-12 - Simplifies the GitHub interface and adds useful features.
...
* [Violentmonkey](https://github.com/violentmonkey/violentmonkey) ⭐ 8,734 | 🐛 79 | 🌐 JavaScript | 📅 2026-08-13 - Provides userscripts support for browsers.
* [Stylus](https://github.com/openstyles/stylus/) ⭐ 6,820 | 🐛 94 | 🌐 JavaScript | 📅 2026-08-11 - Lets you customize websites to any color scheme you like with a lot of styles that you can already choose from.
* [Surfingkeys](https://github.com/brookhong/Surfingkeys) ⭐ 6,142 | 🐛 449 | 🌐 JavaScript | 📅 2026-08-10 - Map your keys for web surfing, expand your browser with javascript and keyboard.
...
* [Video Speed Controller](https://github.com/igrigorik/videospeed) ⭐ 4,407 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-10 - HTML5 video speed controller.
...
* [Redirector](https://chrome.google.com/webstore/detail/redirector/ocgpenflpmgnfapjedencafcfakcekcd) - Automatically redirect pages based on user-defined rules. Examples [here](https://github.com/einaregilsson/Redirector/wiki/Examples-From-Help-File) ⭐ 2,073 | 🐛 176 | 🌐 JavaScript | 📅 2025-07-27 and [here](https://github.com/einaregilsson/Redirector/wiki/Some-Examples) ⭐ 2,073 | 🐛 176 | 🌐 JavaScript | 📅 2025-07-27.
* [Cookie AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) ⭐ 2,011 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26 - Extension that deletes cookies as soon as the tab closes. [Documentation](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete/wiki/Documentation) ⭐ 2,011 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26 and [FAQ](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete/wiki/FAQ:-Common-Questions-and-Issues) ⭐ 2,011 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26.
* [Web Archives](https://github.com/dessant/web-archives) ⭐ 1,582 | 🐛 28 | 🌐 JavaScript | 📅 2026-06-27 - Browser extension for viewing archived and cached versions of web pages.
...
* [SimpleLogin](https://github.com/simple-login/browser-extension) ⭐ 240 | 🐛 45 | 🌐 Vue | 📅 2025-03-20 - Protect your email address using email alias. 100% open source and can be self-hosted.
