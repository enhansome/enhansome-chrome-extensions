...
* [Refined GitHub](https://github.com/sindresorhus/refined-github) ⭐ 32,099 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-09 - Simplifies the GitHub interface and adds useful features.
* [Octotree](https://github.com/buunguyen/octotree) ⭐ 23,243 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 - Gives a file tree view on the side of each repository that you visit that you can use to navigate over the codebase.
...
* [Violentmonkey](https://github.com/violentmonkey/violentmonkey) ⭐ 8,851 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-09 - Provides userscripts support for browsers.
* [Stylus](https://github.com/openstyles/stylus/) ⭐ 6,869 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-05 - Lets you customize websites to any color scheme you like with a lot of styles that you can already choose from.
...
* [Redirector](https://chrome.google.com/webstore/detail/redirector/ocgpenflpmgnfapjedencafcfakcekcd) - Automatically redirect pages based on user-defined rules. Examples [here](https://github.com/einaregilsson/Redirector/wiki/Examples-From-Help-File) ⭐ 2,085 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27 and [here](https://github.com/einaregilsson/Redirector/wiki/Some-Examples) ⭐ 2,085 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27.
