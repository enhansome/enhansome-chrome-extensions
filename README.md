...
* [Refined GitHub](https://github.com/sindresorhus/refined-github) ⭐ 32,175 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-16 - Simplifies the GitHub interface and adds useful features.
...
* [Buster](https://github.com/dessant/buster) ⭐ 9,303 | 🐛 50 | 🌐 JavaScript | 📅 2026-06-27 - Captcha solver extension for humans.
* [Violentmonkey](https://github.com/violentmonkey/violentmonkey) ⭐ 8,886 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-17 - Provides userscripts support for browsers.
* [Stylus](https://github.com/openstyles/stylus/) ⭐ 6,886 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-16 - Lets you customize websites to any color scheme you like with a lot of styles that you can already choose from.
* [Surfingkeys](https://github.com/brookhong/Surfingkeys) ⭐ 6,172 | 🐛 428 | 🌐 JavaScript | 📅 2026-09-11 - Map your keys for web surfing, expand your browser with javascript and keyboard.
...
* [Video Speed Controller](https://github.com/igrigorik/videospeed) ⭐ 4,433 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-10 - HTML5 video speed controller.
...
* [Redirector](https://chrome.google.com/webstore/detail/redirector/ocgpenflpmgnfapjedencafcfakcekcd) - Automatically redirect pages based on user-defined rules. Examples [here](https://github.com/einaregilsson/Redirector/wiki/Examples-From-Help-File) ⭐ 2,088 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27 and [here](https://github.com/einaregilsson/Redirector/wiki/Some-Examples) ⭐ 2,088 | 🐛 177 | 🌐 JavaScript | 📅 2025-07-27.
